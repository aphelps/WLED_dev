...
#   2. Initializes submodules (WLED firmware + ArduinoLibs: MPR121, Debug; esp-now-router).
...
# ---------------------------------------------------------------------------
info "Initializing submodules (WLED, ArduinoLibs, esp-now-router)"
